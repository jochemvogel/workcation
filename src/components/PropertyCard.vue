<template>
  <div class="mt-6 lg:mr-48">
    <div class="bg-red-500 pb-5/6 relative rounded-lg">
      <img class="absolute bottom-0 h-full w-full object-cover rounded-lg shadow-md" :src="property.imageUrl" :alt="property.imageAlt">
    </div>
    <div class="relative px-4 -mt-16">
      <div class="bg-white p-6 rounded-lg shadow-lg">
        <div class="flex items-baseline">
          <span class="inline-block bg-teal-500 text-white text-xs px-2 rounded-full uppercase font-semibold tacking-wide order-last ml-2">New</span>
          <div class="text-gray-600 text-xs uppercase font-semibold tacking-wide order-first">
        ...
        <div class="mt-1">
          ...
          <span class="text-gray-600 text-sm">/ week </span>
        </div>
        <div class="mt-2 flex items-center">
          ...
          <span class="text-gray-600 text-sm ml-2 underline">{{property.reviewCount}} reviews
          </span>
        </div>
      </div>
    </div>
